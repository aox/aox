...
void showSchema()
{
    const char * versions[] = {
        ...
        "0.97", "0.97", "0.98", "0.99", "1.0", // 10-14
        "1.01", "1.05", "1.05", "1.06", "1.07", // 15-19
        "1.08", "1.09", "1.10", "1.10", "1.11", // 20-24
        "1.11", "1.11", "1.11", "1.12", "1.12", // 25-29
        "1.12", "1.12", "1.13", "1.13", "1.15", // 30-34
        "1.15", "1.16", "1.16", "1.16", "1.17", // 35-39
        "1.17", "1.17", "1.17", "2.0", "2.0", "2.0", // 40-45
        "2.0", "2.0", "2.0", "2.01", "2.01"
    };
